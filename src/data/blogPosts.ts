...
const dates: Record<Slug, { datePublished: string; dateModified: string }> = {
  ...
  'v42-20-update': { datePublished: '2026-09-17', dateModified: '2026-09-17' },
...
const titleKeys: Record<Slug, string> = {
  ...
  'v42-20-update': 'blogPost_v42_20_title',
...
const metaKeys: Record<Slug, string> = {
  ...
  'v42-20-update': 'blogPost_v42_20_meta',
...
const excerptKeys: Record<Slug, string> = {
  ...
  'v42-20-update': 'blogPost_v42_20_excerpt',
