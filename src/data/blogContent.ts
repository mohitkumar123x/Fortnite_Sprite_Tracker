    ...
    sections: [
      {
        ...
        blocks: [
          ...
          p('The patch also tweaked existing sprites: detection radius on X-Ray grows faster per level, and several Loot Hacker variants are marked as unreleased pending future activation. Here is every new sprite, its rarity, ability, and whether it is live in-game right now.'),
      ...
      },
      {
        ...
        blocks: [
          p('Loot Hacker variants are separate sprites — not alternate skins of existing ones. Each Loot Hacker spawns in high-elevation areas and has a single variant tier. Most are currently marked as unreleased in the game data, meaning Epic has added them to the files but has not yet enabled them in live matches. Loot Hacker Crown is the exception: it is available now and tracks a modified version of the Crown sprite\'s win-progression ability.'),
